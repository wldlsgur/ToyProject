...
private const val TAG = "NoticAdapter"
class NoticAdapter(val context: Context, var job: String) : RecyclerView.Adapter<NoticAdapter.NoticeViewHolder>() {
    ...
    inner class NoticeViewHolder(itemView:View) : RecyclerView.ViewHolder(itemView){
        ...
        private val writer: TextView = itemView.findViewById(R.id.textViewNotice_writer)

        val moreimg : ImageView = itemView.findViewById(R.id.moreNoticItem)
